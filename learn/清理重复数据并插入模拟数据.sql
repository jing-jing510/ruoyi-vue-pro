...
-- 1. 清理可能存在的重复数据
DELETE FROM `coal_repair_request` WHERE `request_code` IN ('RR202401001', 'RR202401002', 'RR202401003', 'RR202401004', 'RR202401005');
DELETE FROM `coal_maintenance_order` WHERE `order_code` IN ('MO202401001', 'MO202401002', 'MO202401003', 'MO202401004');
